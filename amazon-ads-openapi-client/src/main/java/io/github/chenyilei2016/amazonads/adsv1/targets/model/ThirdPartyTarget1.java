 ...
 */
@JsonPropertyOrder({
  ThirdPartyTarget1.JSON_PROPERTY_THIRD_PARTY_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class ThirdPartyTarget1 {
  ...
  public ThirdPartyTarget1() {
  }

  public ThirdPartyTarget1 thirdPartyTarget(@jakarta.annotation.Nonnull ThirdPartyTarget thirdPartyTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_THIRD_PARTY_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setThirdPartyTarget(@jakarta.annotation.Nonnull ThirdPartyTarget thirdPartyTarget) {
    this.thirdPartyTarget = thirdPartyTarget;
  }


  /**
   * Return true if this thirdPartyTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ThirdPartyTarget1 thirdPartyTarget1 = (ThirdPartyTarget1) o;
    return Objects.equals(this.thirdPartyTarget, thirdPartyTarget1.thirdPartyTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyTarget1 {\n");
