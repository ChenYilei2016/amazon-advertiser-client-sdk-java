...
public class CreateAudienceTarget {
  ...
  public CreateAudienceTarget acrossGroupOperator(@jakarta.annotation.Nullable AcrossGroupOperator acrossGroupOperator) {
  ...
  public CreateAudienceTarget audienceId(@jakarta.annotation.Nonnull CreateMarketplaceStringValue audienceId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AUDIENCE_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAudienceId(@jakarta.annotation.Nonnull CreateMarketplaceStringValue audienceId) {
    this.audienceId = audienceId;
  }


  public CreateAudienceTarget groupId(@jakarta.annotation.Nullable String groupId) {
  ...
  public CreateAudienceTarget inGroupOperator(@jakarta.annotation.Nullable InGroupOperator inGroupOperator) {
