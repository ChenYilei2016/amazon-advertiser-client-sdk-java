...
public class CreateDeviceTarget {
  ...
  public CreateDeviceTarget deviceOrientation(@jakarta.annotation.Nullable DeviceOrientation deviceOrientation) {
  ...
  public CreateDeviceTarget deviceType(@jakarta.annotation.Nonnull DeviceType deviceType) {
  ...
  public CreateDeviceTarget mobileDevice(@jakarta.annotation.Nullable MobileDevice mobileDevice) {
  ...
  public CreateDeviceTarget mobileEnvironment(@jakarta.annotation.Nullable MobileEnvironment mobileEnvironment) {
  ...
  public CreateDeviceTarget mobileOs(@jakarta.annotation.Nullable MobileOs mobileOs) {
