...
/**
 * VideoAdFormatTarget1
 */
@JsonPropertyOrder({
  VideoAdFormatTarget1.JSON_PROPERTY_VIDEO_AD_FORMAT_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class VideoAdFormatTarget1 {
  ...
  public VideoAdFormatTarget1() {
  }

  public VideoAdFormatTarget1 videoAdFormatTarget(@jakarta.annotation.Nonnull VideoAdFormatTarget videoAdFormatTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VIDEO_AD_FORMAT_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setVideoAdFormatTarget(@jakarta.annotation.Nonnull VideoAdFormatTarget videoAdFormatTarget) {
    this.videoAdFormatTarget = videoAdFormatTarget;
  }


  /**
   * Return true if this videoAdFormatTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    VideoAdFormatTarget1 videoAdFormatTarget1 = (VideoAdFormatTarget1) o;
    return Objects.equals(this.videoAdFormatTarget, videoAdFormatTarget1.videoAdFormatTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoAdFormatTarget1 {\n");
