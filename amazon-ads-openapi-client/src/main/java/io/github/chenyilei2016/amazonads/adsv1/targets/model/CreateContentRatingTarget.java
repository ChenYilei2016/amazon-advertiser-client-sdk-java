...
import io.github.chenyilei2016.amazonads.adsv1.targets.model.CreateContentRating;
 ...
 */
@JsonPropertyOrder({
  CreateContentRatingTarget.JSON_PROPERTY_CONTENT_RATING_TYPE,
  CreateContentRatingTarget.JSON_PROPERTY_CONTENT_RATING_TYPE_DETAILS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class CreateContentRatingTarget {
  ...
  @jakarta.annotation.Nonnull
  private CreateContentRating contentRatingTypeDetails;

  public CreateContentRatingTarget() {
  }

  public CreateContentRatingTarget contentRatingType(@jakarta.annotation.Nonnull ContentRatingTypes contentRatingType) {
  ...
  public CreateContentRatingTarget contentRatingTypeDetails(@jakarta.annotation.Nonnull CreateContentRating contentRatingTypeDetails) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public CreateContentRating getContentRatingTypeDetails() {
    return contentRatingTypeDetails;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTENT_RATING_TYPE_DETAILS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContentRatingTypeDetails(@jakarta.annotation.Nonnull CreateContentRating contentRatingTypeDetails) {
    this.contentRatingTypeDetails = contentRatingTypeDetails;
  }


  /**
   * Return true if this CreateContentRatingTarget object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateContentRatingTarget createContentRatingTarget = (CreateContentRatingTarget) o;
    return Objects.equals(this.contentRatingType, createContentRatingTarget.contentRatingType) &&
        Objects.equals(this.contentRatingTypeDetails, createContentRatingTarget.contentRatingTypeDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateContentRatingTarget {\n");
