...
/**
 * ProductAudienceTarget1
 */
@JsonPropertyOrder({
  ProductAudienceTarget1.JSON_PROPERTY_PRODUCT_AUDIENCE_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class ProductAudienceTarget1 {
  ...
  public ProductAudienceTarget1() {
  }

  public ProductAudienceTarget1 productAudienceTarget(@jakarta.annotation.Nonnull ProductAudienceTarget productAudienceTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PRODUCT_AUDIENCE_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProductAudienceTarget(@jakarta.annotation.Nonnull ProductAudienceTarget productAudienceTarget) {
    this.productAudienceTarget = productAudienceTarget;
  }


  /**
   * Return true if this productAudienceTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProductAudienceTarget1 productAudienceTarget1 = (ProductAudienceTarget1) o;
    return Objects.equals(this.productAudienceTarget, productAudienceTarget1.productAudienceTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAudienceTarget1 {\n");
