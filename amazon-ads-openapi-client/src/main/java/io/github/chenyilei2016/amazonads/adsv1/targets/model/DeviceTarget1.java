 ...
 */
@JsonPropertyOrder({
  DeviceTarget1.JSON_PROPERTY_DEVICE_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class DeviceTarget1 {
  public static final String JSON_PROPERTY_DEVICE_TARGET = "deviceTarget";
  @jakarta.annotation.Nonnull
  private DeviceTarget deviceTarget;

  public DeviceTarget1() {
  }

  public DeviceTarget1 deviceTarget(@jakarta.annotation.Nonnull DeviceTarget deviceTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEVICE_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDeviceTarget(@jakarta.annotation.Nonnull DeviceTarget deviceTarget) {
    this.deviceTarget = deviceTarget;
  }


  /**
   * Return true if this deviceTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DeviceTarget1 deviceTarget1 = (DeviceTarget1) o;
    return Objects.equals(this.deviceTarget, deviceTarget1.deviceTarget);
  }
