 ...
 */
@JsonPropertyOrder({
  CreateVideoAdFormatTarget.JSON_PROPERTY_VIDEO_AD_FORMAT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class CreateVideoAdFormatTarget {
  public static final String JSON_PROPERTY_VIDEO_AD_FORMAT = "videoAdFormat";
  @jakarta.annotation.Nonnull
  private VideoAdFormat videoAdFormat;

  public CreateVideoAdFormatTarget() {
  }

  public CreateVideoAdFormatTarget videoAdFormat(@jakarta.annotation.Nonnull VideoAdFormat videoAdFormat) {
  ...
  /**
   * Return true if this CreateVideoAdFormatTarget object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateVideoAdFormatTarget createVideoAdFormatTarget = (CreateVideoAdFormatTarget) o;
    return Objects.equals(this.videoAdFormat, createVideoAdFormatTarget.videoAdFormat);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateVideoAdFormatTarget {\n");
