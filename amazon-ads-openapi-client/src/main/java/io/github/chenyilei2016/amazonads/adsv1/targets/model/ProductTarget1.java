 ...
 */
@JsonPropertyOrder({
  ProductTarget1.JSON_PROPERTY_PRODUCT_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class ProductTarget1 {
  public static final String JSON_PROPERTY_PRODUCT_TARGET = "productTarget";
  @jakarta.annotation.Nonnull
  private ProductTarget productTarget;

  public ProductTarget1() {
  }

  public ProductTarget1 productTarget(@jakarta.annotation.Nonnull ProductTarget productTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PRODUCT_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProductTarget(@jakarta.annotation.Nonnull ProductTarget productTarget) {
    this.productTarget = productTarget;
  }


  /**
   * Return true if this productTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProductTarget1 productTarget1 = (ProductTarget1) o;
    return Objects.equals(this.productTarget, productTarget1.productTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductTarget1 {\n");
