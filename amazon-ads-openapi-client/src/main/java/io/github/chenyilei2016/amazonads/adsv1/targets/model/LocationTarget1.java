...
public class LocationTarget1 {
  ...
  public LocationTarget1 locationTarget(@jakarta.annotation.Nonnull LocationTarget locationTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LOCATION_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLocationTarget(@jakarta.annotation.Nonnull LocationTarget locationTarget) {
    this.locationTarget = locationTarget;
  }
