...
/**
 * InventorySourceTarget1
 */
@JsonPropertyOrder({
  InventorySourceTarget1.JSON_PROPERTY_INVENTORY_SOURCE_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class InventorySourceTarget1 {
  ...
  public InventorySourceTarget1() {
  }

  public InventorySourceTarget1 inventorySourceTarget(@jakarta.annotation.Nonnull InventorySourceTarget inventorySourceTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INVENTORY_SOURCE_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInventorySourceTarget(@jakarta.annotation.Nonnull InventorySourceTarget inventorySourceTarget) {
    this.inventorySourceTarget = inventorySourceTarget;
  }


  /**
   * Return true if this inventorySourceTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InventorySourceTarget1 inventorySourceTarget1 = (InventorySourceTarget1) o;
    return Objects.equals(this.inventorySourceTarget, inventorySourceTarget1.inventorySourceTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class InventorySourceTarget1 {\n");
