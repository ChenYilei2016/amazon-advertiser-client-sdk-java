 ...
 */
@JsonPropertyOrder({
  NativeContentPositionTarget1.JSON_PROPERTY_NATIVE_CONTENT_POSITION_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class NativeContentPositionTarget1 {
  ...
  public NativeContentPositionTarget1() {
  }

  public NativeContentPositionTarget1 nativeContentPositionTarget(@jakarta.annotation.Nonnull NativeContentPositionTarget nativeContentPositionTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_NATIVE_CONTENT_POSITION_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNativeContentPositionTarget(@jakarta.annotation.Nonnull NativeContentPositionTarget nativeContentPositionTarget) {
    this.nativeContentPositionTarget = nativeContentPositionTarget;
  }


  /**
   * Return true if this nativeContentPositionTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NativeContentPositionTarget1 nativeContentPositionTarget1 = (NativeContentPositionTarget1) o;
    return Objects.equals(this.nativeContentPositionTarget, nativeContentPositionTarget1.nativeContentPositionTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class NativeContentPositionTarget1 {\n");
