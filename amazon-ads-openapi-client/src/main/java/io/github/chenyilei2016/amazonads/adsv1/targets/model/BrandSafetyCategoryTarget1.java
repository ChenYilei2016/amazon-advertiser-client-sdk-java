 ...
 */
@JsonPropertyOrder({
  BrandSafetyCategoryTarget1.JSON_PROPERTY_BRAND_SAFETY_CATEGORY_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class BrandSafetyCategoryTarget1 {
  ...
  public BrandSafetyCategoryTarget1() {
  }

  public BrandSafetyCategoryTarget1 brandSafetyCategoryTarget(@jakarta.annotation.Nonnull BrandSafetyCategoryTarget brandSafetyCategoryTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BRAND_SAFETY_CATEGORY_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBrandSafetyCategoryTarget(@jakarta.annotation.Nonnull BrandSafetyCategoryTarget brandSafetyCategoryTarget) {
    this.brandSafetyCategoryTarget = brandSafetyCategoryTarget;
  }


  /**
   * Return true if this brandSafetyCategoryTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BrandSafetyCategoryTarget1 brandSafetyCategoryTarget1 = (BrandSafetyCategoryTarget1) o;
    return Objects.equals(this.brandSafetyCategoryTarget, brandSafetyCategoryTarget1.brandSafetyCategoryTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrandSafetyCategoryTarget1 {\n");
