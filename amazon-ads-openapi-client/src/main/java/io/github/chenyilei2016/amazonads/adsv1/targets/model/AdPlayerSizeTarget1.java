 ...
 */
@JsonPropertyOrder({
  AdPlayerSizeTarget1.JSON_PROPERTY_AD_PLAYER_SIZE_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class AdPlayerSizeTarget1 {
  ...
  public AdPlayerSizeTarget1() {
  }

  public AdPlayerSizeTarget1 adPlayerSizeTarget(@jakarta.annotation.Nonnull AdPlayerSizeTarget adPlayerSizeTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_PLAYER_SIZE_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAdPlayerSizeTarget(@jakarta.annotation.Nonnull AdPlayerSizeTarget adPlayerSizeTarget) {
    this.adPlayerSizeTarget = adPlayerSizeTarget;
  }


  /**
   * Return true if this adPlayerSizeTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AdPlayerSizeTarget1 adPlayerSizeTarget1 = (AdPlayerSizeTarget1) o;
    return Objects.equals(this.adPlayerSizeTarget, adPlayerSizeTarget1.adPlayerSizeTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdPlayerSizeTarget1 {\n");
