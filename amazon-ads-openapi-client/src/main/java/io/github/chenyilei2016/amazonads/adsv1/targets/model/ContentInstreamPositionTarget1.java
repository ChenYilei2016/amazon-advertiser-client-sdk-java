...
public class ContentInstreamPositionTarget1 {
  ...
  public ContentInstreamPositionTarget1 contentInstreamPositionTarget(@jakarta.annotation.Nonnull ContentInstreamPositionTarget contentInstreamPositionTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTENT_INSTREAM_POSITION_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContentInstreamPositionTarget(@jakarta.annotation.Nonnull ContentInstreamPositionTarget contentInstreamPositionTarget) {
    this.contentInstreamPositionTarget = contentInstreamPositionTarget;
  }
