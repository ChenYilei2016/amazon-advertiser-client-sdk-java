 ...
 */
@JsonPropertyOrder({
  ServiceUnavailableErrorResponseContent.JSON_PROPERTY_CODE,
  ServiceUnavailableErrorResponseContent.JSON_PROPERTY_MESSAGE
})
...
public class ServiceUnavailableErrorResponseContent {
  ...
  public ServiceUnavailableErrorResponseContent code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public ServiceUnavailableErrorResponseContent message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this ServiceUnavailableErrorResponseContent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, serviceUnavailableErrorResponseContent.code) &&
        Objects.equals(this.message, serviceUnavailableErrorResponseContent.message);
  }
