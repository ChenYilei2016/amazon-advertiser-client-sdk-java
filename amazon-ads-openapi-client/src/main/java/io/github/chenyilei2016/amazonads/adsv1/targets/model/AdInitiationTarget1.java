 ...
 */
@JsonPropertyOrder({
  AdInitiationTarget1.JSON_PROPERTY_AD_INITIATION_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class AdInitiationTarget1 {
  ...
  public AdInitiationTarget1() {
  }

  public AdInitiationTarget1 adInitiationTarget(@jakarta.annotation.Nonnull AdInitiationTarget adInitiationTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_INITIATION_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAdInitiationTarget(@jakarta.annotation.Nonnull AdInitiationTarget adInitiationTarget) {
    this.adInitiationTarget = adInitiationTarget;
  }


  /**
   * Return true if this adInitiationTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AdInitiationTarget1 adInitiationTarget1 = (AdInitiationTarget1) o;
    return Objects.equals(this.adInitiationTarget, adInitiationTarget1.adInitiationTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdInitiationTarget1 {\n");
