...
/**
 * ContentRatingTarget1
 */
@JsonPropertyOrder({
  ContentRatingTarget1.JSON_PROPERTY_CONTENT_RATING_TARGET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class ContentRatingTarget1 {
  ...
  public ContentRatingTarget1() {
  }

  public ContentRatingTarget1 contentRatingTarget(@jakarta.annotation.Nonnull ContentRatingTarget contentRatingTarget) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTENT_RATING_TARGET, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContentRatingTarget(@jakarta.annotation.Nonnull ContentRatingTarget contentRatingTarget) {
    this.contentRatingTarget = contentRatingTarget;
  }


  /**
   * Return true if this contentRatingTarget_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ContentRatingTarget1 contentRatingTarget1 = (ContentRatingTarget1) o;
    return Objects.equals(this.contentRatingTarget, contentRatingTarget1.contentRatingTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContentRatingTarget1 {\n");
