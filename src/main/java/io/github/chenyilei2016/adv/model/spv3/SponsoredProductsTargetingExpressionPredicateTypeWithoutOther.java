 ...
 */
@JsonAdapter(SponsoredProductsTargetingExpressionPredicateTypeWithoutOther.Adapter.class)
public enum SponsoredProductsTargetingExpressionPredicateTypeWithoutOther {
  ...
  SponsoredProductsTargetingExpressionPredicateTypeWithoutOther(String value) {
    this.value = value;
  }
  ...
  public static SponsoredProductsTargetingExpressionPredicateTypeWithoutOther fromValue(String value) {
    for (SponsoredProductsTargetingExpressionPredicateTypeWithoutOther b : SponsoredProductsTargetingExpressionPredicateTypeWithoutOther.values()) {
  ...
  public static class Adapter extends TypeAdapter<SponsoredProductsTargetingExpressionPredicateTypeWithoutOther> {
    @Override
    public void write(final JsonWriter jsonWriter, final SponsoredProductsTargetingExpressionPredicateTypeWithoutOther enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SponsoredProductsTargetingExpressionPredicateTypeWithoutOther read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SponsoredProductsTargetingExpressionPredicateTypeWithoutOther.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SponsoredProductsTargetingExpressionPredicateTypeWithoutOther.fromValue(value);
  }
}
