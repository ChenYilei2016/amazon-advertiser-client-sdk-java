...
/**
 * Gets or Sets SponsoredProductsKeywordServingStatus
 */
@JsonAdapter(SponsoredProductsKeywordServingStatus.Adapter.class)
public enum SponsoredProductsKeywordServingStatus {
  ...
  SponsoredProductsKeywordServingStatus(String value) {
    this.value = value;
  }
  ...
  public static SponsoredProductsKeywordServingStatus fromValue(String value) {
    for (SponsoredProductsKeywordServingStatus b : SponsoredProductsKeywordServingStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SponsoredProductsKeywordServingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SponsoredProductsKeywordServingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SponsoredProductsKeywordServingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SponsoredProductsKeywordServingStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SponsoredProductsKeywordServingStatus.fromValue(value);
  }
}
