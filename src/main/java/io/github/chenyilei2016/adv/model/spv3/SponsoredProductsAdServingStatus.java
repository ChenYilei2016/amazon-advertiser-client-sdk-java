 ...
 */
@JsonAdapter(SponsoredProductsAdServingStatus.Adapter.class)
public enum SponsoredProductsAdServingStatus {
  ...
  public static class Adapter extends TypeAdapter<SponsoredProductsAdServingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SponsoredProductsAdServingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SponsoredProductsAdServingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SponsoredProductsAdServingStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SponsoredProductsAdServingStatus.fromValue(value);
  }
}
