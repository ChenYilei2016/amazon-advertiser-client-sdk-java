...
/**
 * API tests for MultiCountryThemeBasedBidRecommendationsApi
 */
@Disabled
public class MultiCountryThemeBasedBidRecommendationsApiTest {

    private final MultiCountryThemeBasedBidRecommendationsApi api = new MultiCountryThemeBasedBidRecommendationsApi();
     ...
     */
    @Test
    public void getMultiCountryThemeBasedBidRecommendationForAdGroupV1Test() throws ApiException {
        String amazonAdvertisingAPIClientId = null;
        String amazonAdsAccountId = null;
        GetMultiCountryThemeBasedBidRecommendationForAdGroupV1Request getMultiCountryThemeBasedBidRecommendationForAdGroupV1Request = null;
        MultiCountryThemeBasedBidRecommendationResponse response = api.getMultiCountryThemeBasedBidRecommendationForAdGroupV1(amazonAdvertisingAPIClientId, amazonAdsAccountId, getMultiCountryThemeBasedBidRecommendationForAdGroupV1Request);
