 ...
 */
@JsonAdapter(SponsoredProductsTargetingExpressionPredicateType.Adapter.class)
public enum SponsoredProductsTargetingExpressionPredicateType {
  ...
  public static class Adapter extends TypeAdapter<SponsoredProductsTargetingExpressionPredicateType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SponsoredProductsTargetingExpressionPredicateType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SponsoredProductsTargetingExpressionPredicateType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SponsoredProductsTargetingExpressionPredicateType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SponsoredProductsTargetingExpressionPredicateType.fromValue(value);
  }
}
