 ...
 */
@JsonAdapter(SponsoredProductsAdServingStatusReason.Adapter.class)
public enum SponsoredProductsAdServingStatusReason {
  ...
  public static class Adapter extends TypeAdapter<SponsoredProductsAdServingStatusReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final SponsoredProductsAdServingStatusReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SponsoredProductsAdServingStatusReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SponsoredProductsAdServingStatusReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SponsoredProductsAdServingStatusReason.fromValue(value);
  }
}
